...
Keep routine care, supplies, and appointments visible in one calm view.

This repository contains a complete, local-first TypeScript web application. It is generated as
an independent project, and its neutral repository name is **glade-mooring-3947db681e680edf**.

## What it does

- Captures and validates care item records.
